...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-02-2023 a las 03:14:04
...
--
CREATE DATABASE IF NOT EXISTS `api_flask` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `api_flask`;
...
('235821', 'Lenguaje', 3),
('325817', 'Matemática básica', 5),
('903871', 'Programación', 5);
...
('root', '[{\"db\":\"colegio\",\"table\":\"usuario\"},{\"db\":\"colegio\",\"table\":\"estudiantes\"}]');
...
('root', '2023-02-07 02:13:49', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
